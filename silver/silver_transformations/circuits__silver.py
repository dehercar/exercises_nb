...
# TODOS LOS NOTEBOOKS SON EN ESENCIA UN COPY PASTE DEL PRESENTE NOTEBOOK EXCEPTO POR LAS TRANSFORAMCIONES PARTICULARES DE CADA ENTIDAD A COLUMNAS EN ESPECIFICO
...
df = df.withColumn('alt', col('alt').cast('double'))
